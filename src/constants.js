...
module.exports = {
    ...
    USER_AGENT:
        "wow.export (" + (isUnitTest ? "0.0.0" : nw.App.manifest.version) + ")",
    ...
    PRODUCTS: [
        ...
        },
        {
            ...
            title: "Beta: World of Warcraft Classic",
            tag: "Classic Beta",
        },
        {
            product: "wow_classic_ptr",
            title: "PTR: World of Warcraft Classic",
            tag: "Classic PTR",
        },
    ],
    ...
    PATCH: {
        ...
        DEFAULT_REGION: "kr",                           // Region which is selected by default.
